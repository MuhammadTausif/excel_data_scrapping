...
var workbook = XLSX.readFile('dp.xlsx', {
  cellStyles: true
});
      ...
      if (typeof nextCell === 'undefined') {
        ...
        if (colNum == 0) {
          ...
          if (typeof nextCell.s.fgColor != "undefined") {
            if (nextCell.s.fgColor.rgb == '93CDDD' || nextCell.s.fgColor.rgb == 'FBE5D6' || nextCell.s.fgColor.rgb == 'F4B183' ) {
        ...
        if (blueTotalTestFlag) {
          ...
          if (rowNum == blueTotalRow) {
            ...
            //FFFF00 Yellow 
            if (typeof nextCell.s.fgColor != "undefined") {
              if (nextCell.s.fgColor.rgb == 'FFFF00' ) {
...
fs.writeFile('yellow_pink.json', JSON.stringify(json_data, null, 100));